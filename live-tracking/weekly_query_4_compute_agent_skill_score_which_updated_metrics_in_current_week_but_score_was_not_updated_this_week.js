...
const agg = [
  {
      ...
      '$and': [
        {
          'agent_skill_metrics_modified_at': {
            '$gte': new Date('Sun, 05 Oct 2025 00:00:00 GMT'), 
            '$lt': new Date('Sun, 12 Oct 2025 00:00:00 GMT')
          }
        }, {
          'score_calculated_at': {
            '$lt': new Date('Sun, 05 Oct 2025 00:00:00 GMT')
          }
        }
      ], 
      'is_deleted': false
      ...
      'pipeline': [
        {
          ...
          '$project': {
            '_id': 0, 
            'global_max_ticket_resolved': '$max_ticket_resolved', 
            'global_min_avg_resolution_time': '$min_avg_resolution_time'
          }
        }
      ], 
      'as': 'global_metrics'
    ...
    '$addFields': {
      'global_max_ticket_resolved': '$global_metrics.global_max_ticket_resolved', 
      'global_min_avg_resolution_time': '$global_metrics.global_min_avg_resolution_time'
    }
  }, {
    '$addFields': {
      'score': {
